    ...
    return (
        <Container maxW="container.md">
            <Box my={8}>
                ...
                {/* Services Provided */}
                <Heading as="h2" size="md" mt={10}>2. Services Provided</Heading>
                <Text mt={4}>Universal Grave addresses the issue of spam in the Web3 space by enabling Universal Profile (LSP0) accounts to redirect unwanted LSP7 and LSP8 digital assets to a specialized Vault, termed the Universal Grave. Users can 'revive' desired assets from the GRAVE back to their Universal Profile. Note that the revival of assets is subject to a fee as outlined in the "Fees for Services" section below.</Text>
                {/* Use of Service */}
                <Heading as="h2" size="md" mt={10}>3. Use of Service</Heading>
                ...
                <List spacing={2} mt={4}>
                    <ListItem>A fixed fee of 0.005 LYX is charged per revival action.</ListItem>
                    <ListItem>Fees are subject to change at our discretion. We will endeavor to notify you of any fee changes in a timely manner.</ListItem>
                    <ListItem>Fees are non-refundable except as required by law or as explicitly set forth in these Terms.</ListItem>
                </List>
                ...
                <Text mt={4}>
                    ...
                    please be aware that all transactions are public and immutable due to the nature of blockchain.
                </Text>
                ...
                <Text mt={4}>
                    ...
                    or punitive damages, including without limitation, loss of profits, data, or other intangible losses, resulting from (i) your access to or use of or inability to access or use the Service; 
                ...
                <Text mt={4}>
                    ...
                    You agree that [Your Company Name] shall not be liable to you or to any third party for any modification, suspension, or discontinuance of the Service.
                </Text>
                ...
                <Heading as="h2" size="md" mt={10}>2. Disputes</Heading>
                <Text mt={4}>
                    Any disputes arising out of or related to these Terms will be resolved through binding arbitration in accordance with the laws of the United Arab Emirates.
                </Text>
                ...
                <Heading as="h2" size="md" mt={10}>2. Non-Waiver</Heading>
                <Text mt={4}>
