...
export interface ERC725InitInterface extends Interface {
  getFunction(
    nameOrSignature:
      | 'execute'
      | 'executeBatch'
...
export interface ERC725Init extends BaseContract {
  connect(runner?: ContractRunner | null): ERC725Init;
  waitForDeployment(): Promise<this>;

  interface: ERC725InitInterface;
