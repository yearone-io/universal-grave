...
export const UpgradeURD = ({
  ...
  const { setURDLsp7, setURDLsp8 } = useGrave();

  const account = profileDetailsData?.upWallet || null;
  const mainUPController = profileDetailsData?.mainUPController || null;
          ...
          {!step.complete ? (
              ...
              {step.instructions2 &&
                ...
                networkConfig && (
                  <Flex>
                    ...
                    <a
                      href={`${networkConfig.explorer}/address/${step.instructions2.address}`}
            ...
            <StepDescription as={'div'}>
              <Flex alignItems="center" gap={1}>
                ...
                {step.completeText.address && networkConfig && (
                  <a
                    href={`${networkConfig.explorer}/address/${step.completeText.address}`}
                    style={{ textDecoration: 'underline' }}
                    target="_blank"
                  >
